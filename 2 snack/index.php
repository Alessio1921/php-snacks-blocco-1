    ...
    <?php 
      ...
      foreach ($ads as $key => $value) {
        if($value["is_active"]== true){
          array_push($advertisingActive,$value);
        }
      }
      $randomNumber=random_int(0,count($advertisingActive)-1);
      var_dump($randomNumber);
    ?>
    <img src="<?php echo $advertisingActive[$randomNumber]['image_path']?>" alt="" srcset="">
  </body>
</html>